...
app.controller('HotelProdreportCntr', ['$scope', '$http', '$window', '$rootScope', function ($scope, $http, $window, $rootScope) {
    ...
    $scope.GetReportDetails = function () {
        ...
        PopUpController.OpenPopup1("divPopup", "Hotel Productivity Report API", popupdetail);
        ...
        $http({
            method: "post",
            url: "../Production/GetHotelProductivityReportAPI",
            data: ({
            ...
            $('#HotelProd').DataTable({
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        "className": "text-left",
                        "visible": groupColumn == "2" ? false : true,
                    },
                    {
                        "targets": 3,
                        orderable: false,
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        "className": "text-left",
                        "visible": groupColumn == "4" ? false : true,
                    },
                    {
                        "targets": 5,
                        orderable: false,
...
function GetHideColList(GroupBy) {
    ...
    HideColList.push("0~HotelId~HotelCode");
    HideColList.push("1~SName~HotelName");
    HideColList.push("2~Country~CountryName");
    HideColList.push("3~CountryCode~CountryCode");
    HideColList.push("4~City~CityName");
    HideColList.push("5~SuppCityCode~SupplierCityCode");
    HideColList.push("6~HotelAddress~HotelAddress");
    HideColList.push("7~StarCat~StarCategory");
    HideColList.push("8~Nts~No Of RoomNts");
    HideColList.push("9~TelePhone~TelePhone");
    HideColList.push("10~Latitude~Latitude");
    HideColList.push("11~Longitude~Longitude");
    HideColList.push("12~HotelDescription~Description");
    HideColList.push("13~ImagePath~ImagePath");
    HideColList.push("14~GiataId~GiataId");
    HideColList.push("15~ExpediaHCode~ExpediaHotelCode");
    HideColList.push("16~HBHCode~HotelBedsHotelCode");
    HideColList.push("17~AgodaHCode~AgodaHotelCode");
    HideColList.push("18~TGXCode~TGXCode");
 
    if (GroupBy != "") {
        var NewHideColList = [];
        switch (GroupBy) {
            case '2':
                NewHideColList = removeElementsfromhidelist(HideColList, '2~Country~CountryName');
                break;
            case '4':
                NewHideColList = removeElementsfromhidelist(HideColList, '4~City~CityName');
                break;
